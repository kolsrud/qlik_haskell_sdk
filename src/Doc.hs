...
checkExpression :: Doc -> String -> [String] -> SDKM CheckExpressionResult
checkExpression obj expr labels = checkExpressionAsync obj expr labels >>= awaitResult
...
checkExpressionAsync :: Doc -> String -> [String] -> SDKM (Task CheckExpressionResult)
checkExpressionAsync obj expr labels =
...
applyBookmark_qsAsync obj id =
  let args = [ ("qId", toValue id) ]
   in sendRequestM (getHandle obj) "ApplyBookmark_qs" args (onSingleValueResponse "ApplyBookmark_qs" "qSuccess")
...
getAllInfos_qsAsync obj =
  sendRequestM (getHandle obj) "GetAllInfos_qs" [] (onSingleValueResponse "GetAllInfos_qs" "qInfos")
...
publish :: Doc -> String -> String -> SDKM ()
publish obj streamId name = publishAsync obj streamId name >>= awaitResult

publishAsync :: Doc -> String -> String -> SDKM (Task ())
publishAsync obj streamId name =
...
getMatchingFields :: Doc -> [String] -> NxMatchingFieldMode -> SDKM [NxMatchingFieldInfo]
getMatchingFields obj tags matchingFieldMode = getMatchingFieldsAsync obj tags matchingFieldMode >>= awaitResult

getMatchingFieldsAsync :: Doc -> [String] -> NxMatchingFieldMode -> SDKM (Task [NxMatchingFieldInfo])
getMatchingFieldsAsync obj tags matchingFieldMode =
...
doReloadEx :: Doc -> DoReloadExParams -> SDKM DoReloadExResult
doReloadEx obj params = doReloadExAsync obj params >>= awaitResult

doReloadExAsync :: Doc -> DoReloadExParams -> SDKM (Task DoReloadExResult)
doReloadExAsync obj params =
...
getSetAnalysis :: Doc -> String -> String -> SDKM String
getSetAnalysis obj stateName bookmarkId = getSetAnalysisAsync obj stateName bookmarkId >>= awaitResult

getSetAnalysisAsync :: Doc -> String -> String -> SDKM (Task String)
getSetAnalysisAsync obj stateName bookmarkId =
...
getField :: Doc -> String -> String -> SDKM Field
getField obj fieldName stateName = getFieldAsync obj fieldName stateName >>= awaitResult

getFieldAsync :: Doc -> String -> String -> SDKM (Task Field)
getFieldAsync obj fieldName stateName =
...
clearAll :: Doc -> Bool -> String -> SDKM ()
clearAll obj lockedAlso stateName = clearAllAsync obj lockedAlso stateName >>= awaitResult

clearAllAsync :: Doc -> Bool -> String -> SDKM (Task ())
clearAllAsync obj lockedAlso stateName =
...
lockAll :: Doc -> String -> SDKM ()
lockAll obj stateName = lockAllAsync obj stateName >>= awaitResult

lockAllAsync :: Doc -> String -> SDKM (Task ())
lockAllAsync obj stateName =
  let args = [ ("qStateName", toValue stateName) ]
   in sendRequestM (getHandle obj) "LockAll" args (onMultiValueResponse "LockAll")

unlockAll :: Doc -> String -> SDKM ()
unlockAll obj stateName = unlockAllAsync obj stateName >>= awaitResult

unlockAllAsync :: Doc -> String -> SDKM (Task ())
unlockAllAsync obj stateName =
  let args = [ ("qStateName", toValue stateName) ]
...
getEmptyScript :: Doc -> String -> SDKM String
getEmptyScript obj localizedMainSection = getEmptyScriptAsync obj localizedMainSection >>= awaitResult

getEmptyScriptAsync :: Doc -> String -> SDKM (Task String)
getEmptyScriptAsync obj localizedMainSection =
...
doReload :: Doc -> Int -> Bool -> Bool -> SDKM Bool
doReload obj mode partial debug = doReloadAsync obj mode partial debug >>= awaitResult

doReloadAsync :: Doc -> Int -> Bool -> Bool -> SDKM (Task Bool)
doReloadAsync obj mode partial debug =
...
doSave :: Doc -> String -> SDKM ()
doSave obj fileName = doSaveAsync obj fileName >>= awaitResult

doSaveAsync :: Doc -> String -> SDKM (Task ())
doSaveAsync obj fileName =
...
getFieldAndColumnSamples :: Doc -> [FieldOrColumn] -> Int -> Int -> SDKM [SampleResult]
getFieldAndColumnSamples obj fieldsOrColumnsWithWildcards maxNumberOfValues randSeed = getFieldAndColumnSamplesAsync obj fieldsOrColumnsWithWildcards maxNumberOfValues randSeed >>= awaitResult

getFieldAndColumnSamplesAsync :: Doc -> [FieldOrColumn] -> Int -> Int -> SDKM (Task [SampleResult])
getFieldAndColumnSamplesAsync obj fieldsOrColumnsWithWildcards maxNumberOfValues randSeed =
